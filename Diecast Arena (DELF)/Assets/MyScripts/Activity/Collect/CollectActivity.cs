...
public class CollectActivity : MonoBehaviour
{
    ...
    void FinishCleared()
    {
        ...
        ActivityLog.WriteActivityResult(Methods.GetPlayerName(), activityIndex, score + " (Cleared)");
    }
    ...
    void FinishTimesUp()
    {
        ...
        ActivityLog.WriteActivityResult(Methods.GetPlayerName(), activityIndex, score.ToString());
    }
